...
namespace CHARACTERS
{
    public class CharacterManager : MonoBehaviour
    {
        ...
        [SerializeField] private RectTransform _characterpannel_model3D = null; // 3D模型角色面板
        ...
        public RectTransform characterPanelModel3D => _characterpannel_model3D; // 3D模型面板访问器
