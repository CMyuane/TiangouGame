...
//Õâ¸ö½Å±¾¶¨ÒåÁËÒ»¸ö³éÏóµÄ½ÇÉ«Àà£¬±úæ¾ÓÎÏ·ÖÐµÄ½ÇÉ«¡£ËEE¬ÁË½ÇÉ«µÄ»ù±¾ÊôÐÔºÍ·½·¨£¬ÓÃÓÚ´¦ÀúÙÇÉ«µÄ¶Ô»°ºÍÎÄ±¾ÑùÊ½µÈ¹¦ÄÜ¡£
namespace CHARACTERS
{
    public abstract class Character
    {
        ...
        public bool isUnHighlighting => (!highlighted && co_highlighting != null); // Õâ¸öÊôÐÔ±úæ¾½ÇÉ«ÊÇ·ñÕýÔÚÈ¡Ïû¸ßÁÁÏÔÊ¾
        ...
        public virtual void SetColor(Color color)
        {
            ...
            // ÀýÈç£¬Ê¹ÓÃ²ÄÖÊ»òÆäËû·½Ê½À´¸Ä±ä½ÇÉ«µÄÑÕÉ«
        }
        ...
        {
            Debug.Log("¸Ã½ÇÉ«ÀàÐÍ²»Ö§³Ö¸ßÁÁÏÔÊ¾¡£");
            yield return null;
        }
