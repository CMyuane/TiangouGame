...
//ﾕ篋ﾅｱｾｶｨﾒ蠱ﾋﾒｻｸ鰕ﾄｽﾇﾉｫﾀ爛ｬｱ桄ｾﾓﾎﾏｷﾖﾐｵﾄｽﾇﾉｫ｡｣ﾋ・・ｬﾁﾋｽﾇﾉｫｵﾄｻｾﾊﾔｺﾍｷｽｷｨ｣ｬﾓﾃﾓﾚｴｦﾀ晳ﾇﾉｫｵﾄｶﾔｻｰｺﾍﾎﾄｱｾﾑｽｵﾈｹｦﾄﾜ｡｣
namespace CHARACTERS
{
    public abstract class Character
    {
        // ｽﾇﾉｫｵﾄｻｾﾅ葷ﾃﾊｾﾝ
        public const bool ENABLE_ON_START = false; //ｴｴｽｨﾊｱｲｻｿﾉｼ・
        ...
        public bool isUnHighlighting => (!highlighted && co_highlighting != null); // ﾕ篋ﾔｱ桄ｾｽﾇﾉｫﾊﾇｷﾔﾚﾈ｡ﾏ鄕ﾟﾁﾁﾏﾔﾊｾ
        ...
        {
            this.color = color;
            // ﾕ簑・ﾉﾒﾔﾌ晴ﾓｶﾔｽﾇﾉｫﾑﾕﾉｫｵﾄﾉ靹ﾃﾂﾟｼｭ
            // ﾀﾈ逎ｬﾊｹﾓﾃｲﾄﾖﾊｻ萢都ｽﾊｽﾀｴｸﾄｱ菴ﾇﾉｫｵﾄﾑﾕﾉｫ
        }
        ...
        {
            Debug.Log("ｸﾃｽﾇﾉｫﾀ獎ﾍｲｻﾖｧｳﾖﾑﾕﾉｫｽ･ｱ茖｣");
            yield return null;
        }
        ...
        {
            Debug.Log("ｸﾃｽﾇﾉｫﾀ獎ﾍｲｻﾖｧｳﾖｸﾟﾁﾁﾏﾔﾊｾ｡｣");
            yield return null;
        }
